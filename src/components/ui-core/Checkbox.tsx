...
const Checkbox: Component<PolymorphicStyledCheckboxProps> = (props) => {
  ...
  return (
    <CheckboxPrimitive class={cn("items-center group flex space-x-2", props.class)} {...rest}>
      ...
      <CheckboxPrimitive.Control class="h-[20px] w-[20px] rounded-sm border border-gray-200 bg-slate-800 hover:bg-slate-700 transition-all data-checked:bg-orange-700 data-checked:hover:bg-orange-700 data-checked:text-white">
